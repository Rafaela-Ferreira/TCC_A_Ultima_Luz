...
public class ArvoreSeca4 extends BlocosInterativos{

    PainelDoJogo painel;

    public ArvoreSeca4(PainelDoJogo painel, int coluna, int linha) {
        ...
        baixo1 = setup("/res/blocosInterativos/arvore4", painel.tamanhoDoTile, painel.tamanhoDoTile);
        destruir = true;
        vida = 3;
    }
