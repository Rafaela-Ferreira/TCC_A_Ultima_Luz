...
public class BesouroAzul extends Entidade{
    ...
    public BesouroAzul(PainelDoJogo painel) {
        super(painel);
    ...
    public void getImagem(){
        cima1 = setup("/res/inimigo/BesouroAzul1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        cima2 = setup("/res/inimigo/BesouroAzul2", painel.tamanhoDoTile, painel.tamanhoDoTile);
        baixo1 = setup("/res/inimigo/BesouroAzul1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        baixo2 = setup("/res/inimigo/BesouroAzul2", painel.tamanhoDoTile, painel.tamanhoDoTile);
        esquerda1 = setup("/res/inimigo/BesouroAzul1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        esquerda2 = setup("/res/inimigo/BesouroAzul2", painel.tamanhoDoTile, painel.tamanhoDoTile);
        direita1 = setup("/res/inimigo/BesouroAzul1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        direita2 = setup("/res/inimigo/BesouroAzul2", painel.tamanhoDoTile, painel.tamanhoDoTile);
    }
