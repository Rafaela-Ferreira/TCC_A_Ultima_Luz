...
public class SelarysATentadoraDasAlmas extends Entidade{

    PainelDoJogo painel;
    public static final String nomeBoss = "Selarys, a Tentadora das Almas"; 

    public SelarysATentadoraDasAlmas(PainelDoJogo painel) {
        super(painel);
    ...
    public void verificarDrop(){
        ...
        Progresso.selarysATentadoraDasAlmas = true;
        ...
        if(i < 50){
            ...
            droparItem(new ObjFragmentoCarmesim(painel));
        }
        if(i >= 50 && i < 75){
