...
public class DariusOColecionadorDeAlmas extends Entidade{
    ...
    PainelDoJogo painel;
    public static final String nomeBoss = "Darius, o Colecionador de Almas"; // 2° boss Avareza

    public DariusOColecionadorDeAlmas(PainelDoJogo painel) {
        super(painel);
    ...
    public void verificarDrop(){
        ...
        Progresso.dariusOColecionadorDeAlmas = true;
