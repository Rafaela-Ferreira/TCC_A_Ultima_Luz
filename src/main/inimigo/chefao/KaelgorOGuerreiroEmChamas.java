...
public class KaelgorOGuerreiroEmChamas extends Entidade{

    PainelDoJogo painel;
    public static final String nomeBoss = "Kaelgor, o Guerreiro em Chamas"; 

    public KaelgorOGuerreiroEmChamas(PainelDoJogo painel) {
        super(painel);
    ...
    public void verificarDrop(){
        ...
        Progresso.kaelgorOGuerreiroEmChamas = true;
