...
public class ThalrenOCavaleiroEsquecido extends Entidade{

    PainelDoJogo painel;
    public static final String nomeBoss = "Thalren, o Cavaleiro Esquecido"; 

    public ThalrenOCavaleiroEsquecido(PainelDoJogo painel) {
        super(painel);
    ...
    public void verificarDrop(){
        ...
        Progresso.thalrenOCavaleiroEsquecido = true;
        ...
        if(i < 50){
            ...
            droparItem(new ObjFragmentoOnirico(painel));
        }
        if(i >= 50 && i < 75){
