...
public class AurionOArcanjoCaido extends Entidade{

    PainelDoJogo painel;
    public static final String nomeBoss = "Aurion, o Arcanjo Caido"; 

    public AurionOArcanjoCaido(PainelDoJogo painel) {
        super(painel);
    ...
    public void verificarDrop(){
        ...
        Progresso.aurionOArcanjoCaido = true;
        ...
        droparItem(new ObjAlmaChefao4(painel), -16, 0);
