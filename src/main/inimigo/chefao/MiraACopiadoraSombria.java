...
public class MiraACopiadoraSombria extends Entidade{

    PainelDoJogo painel;
    public static final String nomeBoss = "Mira, a Copiadora Sombria"; 

    public MiraACopiadoraSombria(PainelDoJogo painel) {
        super(painel);
    ...
    public void verificarDrop(){
        ...
        Progresso.miraACopiadoraSombria = true;
        ...
        if(i < 50){
            ...
            droparItem(new ObjFragmentoSombrio(painel));
        }
        if(i >= 50 && i < 75){
