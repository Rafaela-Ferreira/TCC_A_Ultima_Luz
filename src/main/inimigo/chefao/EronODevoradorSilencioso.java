...
public class EronODevoradorSilencioso extends Entidade{
    ...
    PainelDoJogo painel;
    public static final String nomeBoss = "Eron, O Devorador Silencioso"; // 1° boss GULA

    public EronODevoradorSilencioso(PainelDoJogo painel) {
        super(painel);
    ...
    public void verificarDrop(){
        ...
        Progresso.eronODevoradorSilencioso = true;
