...
public class ArvoreSeca3 extends BlocosInterativos{

    PainelDoJogo painel;

    public ArvoreSeca3(PainelDoJogo painel, int coluna, int linha) {
        ...
        baixo1 = setup("/res/blocosInterativos/arvore3", painel.tamanhoDoTile, painel.tamanhoDoTile);
        destruir = true;
        vida = 3;
    }
